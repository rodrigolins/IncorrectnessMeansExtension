...
public abstract class AbstractTimedProperty {
	...
	private String unit;
	private Long time;
	private TimedPropertyBoundary boundary;

	public AbstractTimedProperty() {
	}

	public AbstractTimedProperty(Long id, PropertyType propertyType,
			Float value, String unit, Long time, TimedPropertyBoundary boundary) {
		this.id = id;
	...
	public TimedPropertyBoundary getBoundary() {
		return this.boundary;
	}

	public void setBoundary(TimedPropertyBoundary boundary) {
		this.boundary = boundary;
	}
