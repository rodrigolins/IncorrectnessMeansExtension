...
public abstract class AbstractArduinoSamplingRepository
	...
	public List<ArduinoValue> getArduinoSamples() {
		...
		int countInCallStack = ReflectionHelper.countContainedInCallStack(
				"getArduinoSamples", this);

		if (countInCallStack > 1 || iArduinoSamplingProviderRoles.size() == 0)
			return getArduinoSamplesImpl();
		else
			return iArduinoSamplingProviderRoles.get(0).getArduinoSamples();

	}

	public abstract List<ArduinoValue> getArduinoSamplesImpl();
